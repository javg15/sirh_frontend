...
import Semestre, { SemestreInitializer, SemestreId } from './semestre';
...
interface ModelTypeMap {
  ...
  'cattipohorasdocente': Cattipohorasdocente;
...
interface ModelIdTypeMap {
  ...
  'catplantillas': CatplantillasId;
  'catquincena': CatquincenaId;
  'cattipohorasdocente': CattipohorasdocenteId;
...
type Initializer =
  ...
  | CattipohorasdocenteInitializer
...
interface InitializerTypeMap {
  ...
  'cattipohorasdocente': CattipohorasdocenteInitializer;
...
export {
  ...
  Cattipocategoria, CattipocategoriaInitializer,
  Cattipocentrotrabajo, CattipocentrotrabajoInitializer,
  Cattipohorasdocente, CattipohorasdocenteInitializer, CattipohorasdocenteId,
  Cattiponomina, CattiponominaInitializer,
  Catturnos, CatturnosInitializer,
  ...
  Semestre, SemestreInitializer, SemestreId,
