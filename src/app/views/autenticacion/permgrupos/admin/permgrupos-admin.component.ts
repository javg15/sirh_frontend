...
@Component({
  selector: 'app-permgrupos-admin',
  templateUrl: './permgrupos-admin.component.html',

})


export class PermgruposAdminComponent implements OnInit {
  ...
  nombreModulo = 'Permgrupos';

  headersAdmin: any;

  /* En el constructor creamos el objeto permgruposService,
  ...
  constructor(
    private permgruposService: PermgruposService,private route: ActivatedRoute
  ) {
  ...
  openModal(id: string, accion: string, idItem: number) {
    this.permgruposService.open(id, accion, idItem);
  }

  closeModal(id: string) {
    this.permgruposService.close(id);
  }
