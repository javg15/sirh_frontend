...
export class CattiponominaService {
    ...
    return new Observable((o) => {
      setTimeout(() => {
        this.http.post<DataTablesResponse>(
          ...
          this.API_URL + '/cattiponomina/getAdmin',
  ...
  public getCatalogo(): Observable<any> {
    return this.http.post(this.API_URL + '/cattiponomina/getCatalogo',
      {}
      , httpOptions);
  }
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/cattiponomina/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack, actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/cattiponomina/setRecord',
      { dataPack, actionForm }
      , httpOptions);
  }
