...
export class MateriasclaseService {
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/materiasclase/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack, actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/materiasclase/setRecord',
      { dataPack, actionForm }
      , httpOptions);
  }
  ...
  public getCatalogo(): Observable<any> {
    return this.http.post(this.API_URL + '/materiasclase/getCatalogo',
      {}
      , httpOptions);
  }
