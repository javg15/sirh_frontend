...
@Component({
  selector: 'app-materiasclase-admin',
  templateUrl: './materiasclase-admin.component.html',

})


export class MateriasclaseAdminComponent implements OnInit {
  ...
  nombreModulo = 'Materiasclase';

  headersAdmin: any;

  /* En el constructor creamos el objeto materiasclaseService,
  ...
  constructor(
    private materiasclaseService: MateriasclaseService,private route: ActivatedRoute
  ) {
    ...
    this.headersAdmin = this.route.snapshot.data.userdata; // get data from resolver
      ...
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.materiasclaseService.http
            .post<DataTablesResponse>(
              // this.API_URL + '/a6b_apis/read_records_dt.php',
              this.API_URL + '/materiasclase/getAdmin',
  ...
  openModal(id: string, accion: string, idItem: number) {
    this.materiasclaseService.open(id, accion, idItem);
  }

  closeModal(id: string) {
    this.materiasclaseService.close(id);
  }
