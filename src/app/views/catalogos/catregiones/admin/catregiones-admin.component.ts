...
@Component({
  selector: 'app-catregiones-admin',
  templateUrl: './catregiones-admin.component.html',
  styleUrls: ['./catregiones-admin.component.css', '../../../_shared/shared.css']
})


export class CatregionesAdminComponent implements OnInit {
  ...
  nombreModulo = 'Catregiones';

  headersAdmin: any;

  /* En el constructor creamos el objeto catregionesService,
  ...
  constructor(
    private catregionesService: CatregionesService,private route: ActivatedRoute
  ) {
    ...
    this.headersAdmin = this.route.snapshot.data.userdata; // get data from resolver
      ...
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.catregionesService.http
            .post<DataTablesResponse>(
              // this.API_URL + '/a6b_apis/read_records_dt.php',
              this.API_URL + '/catregiones/getAdmin',
  ...
  openModal(id: string, accion: string, idItem: number) {
    this.catregionesService.open(id, accion, idItem);
  }

  closeModal(id: string) {
    this.catregionesService.close(id);
  }
