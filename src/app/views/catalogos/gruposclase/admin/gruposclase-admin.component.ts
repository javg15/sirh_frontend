...
@Component({
  selector: 'app-gruposclase-admin',
  templateUrl: './gruposclase-admin.component.html',

})


export class GruposclaseAdminComponent implements OnInit {
  ...
  nombreModulo = 'Gruposclase';

  headersAdmin: any;

  /* En el constructor creamos el objeto gruposclaseService,
  ...
  constructor(
    private gruposclaseService: GruposclaseService,private route: ActivatedRoute
  ) {
  ...
  openModal(id: string, accion: string, idItem: number) {
    this.gruposclaseService.open(id, accion, idItem);
  }

  closeModal(id: string) {
    this.gruposclaseService.close(id);
  }
