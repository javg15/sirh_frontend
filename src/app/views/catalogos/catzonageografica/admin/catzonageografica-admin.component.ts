...
export class CatzonageograficaAdminComponent implements OnInit {
  ...
  nombreModulo = 'Catzonageografica';

  headersAdmin: any;

  /* En el constructor creamos el objeto catzonageograficaService,
  ...
  constructor(
    private catzonageograficaService: CatzonageograficaService,private route: ActivatedRoute
  ) {
    ...
    this.headersAdmin = this.route.snapshot.data.userdata; // get data from resolver
      ...
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.catzonageograficaService.http
            .post<DataTablesResponse>(
              // this.API_URL + '/a6b_apis/read_records_dt.php',
              this.API_URL + '/catzonageografica/getAdmin',
  ...
  closeModal(id: string) {
    this.catzonageograficaService.close(id);
  }
