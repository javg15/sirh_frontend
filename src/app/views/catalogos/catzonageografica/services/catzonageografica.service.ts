...
export class CatzonageograficaService {
  ...
  public getCatalogo(): Observable<any> {
    return this.http.post(this.API_URL + '/catzonageografica/getCatalogo',
      {}
      , httpOptions);
  }
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/catzonageografica/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack, actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/catzonageografica/setRecord',
      { dataPack, actionForm }
      , httpOptions);
  }
