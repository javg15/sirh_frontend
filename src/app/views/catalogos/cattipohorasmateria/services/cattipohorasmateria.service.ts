...
export class CattipohorasmateriaService {
    ...
    return new Observable((o) => {
      setTimeout(() => {
        this.http.post<DataTablesResponse>(
          ...
          this.API_URL + '/cattipohorasmateria/getAdmin',
  ...
  public getCatalogo(): Observable<any> {
    return this.http.post(this.API_URL + '/cattipohorasmateria/getCatalogo',
      {}
      , httpOptions);
  }
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/cattipohorasmateria/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack, actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/cattipohorasmateria/setRecord',
      { dataPack, actionForm }
      , httpOptions);
  }
