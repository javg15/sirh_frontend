...
export class CatestatushoraService {
    ...
    return new Observable((o) => {
      setTimeout(() => {
        this.http.post<DataTablesResponse>(
          ...
          this.API_URL + '/catestatushora/getAdmin',
  ...
  public getCatalogo(): Observable<any> {
    return this.http.post(this.API_URL + '/catestatushora/getCatalogo',
      {}
      , httpOptions);
  }
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/catestatushora/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack, actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/catestatushora/setRecord',
      { dataPack, actionForm }
      , httpOptions);
  }
