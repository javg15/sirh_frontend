...
export class CatcentrostrabajoService {
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/catcentrostrabajo/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack, actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/catcentrostrabajo/setRecord',
      { dataPack, actionForm }
      , httpOptions);
  }
