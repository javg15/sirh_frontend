...
export class CatesquemapagoService {
    ...
    return new Observable((o)=>{
      setTimeout(()=>{
        this.http.post<DataTablesResponse>(
          ...
          this.API_URL + '/catesquemapago/getAdmin',
  ...
  public getCatalogo(): Observable<any> {
    return this.http.post(this.API_URL + '/catesquemapago/getCatalogo',
      {  }
      , httpOptions);
  }

  public getCatalogoSegunSexo(id_sexo): Observable<any> {
    return this.http.post(this.API_URL + '/catesquemapago/getCatalogoSegunSexo',
      { id_sexo }
      , httpOptions);
  }
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/catesquemapago/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack,actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/catesquemapago/setRecord',
      { dataPack,actionForm }
      , httpOptions);
  }
