...
@Component({
  selector: 'app-catplanteles-admin',
  templateUrl: './catplanteles-admin.component.html',
  styleUrls: ['./catplanteles-admin.component.css', '../../../_shared/shared.css']
})


export class CatplantelesAdminComponent implements OnInit {
  ...
  nombreModulo = 'Catplanteles';

  headersAdmin: any;

  /* En el constructor creamos el objeto catplantelesService,
  ...
  constructor(
    private catplantelesService: CatplantelesService,private route: ActivatedRoute
  ) {
  ...
  openModal(id: string, accion: string, idItem: string) {
    this.catplantelesService.open(id, accion, idItem);
  }

  closeModal(id: string) {
    this.catplantelesService.close(id);
  }
