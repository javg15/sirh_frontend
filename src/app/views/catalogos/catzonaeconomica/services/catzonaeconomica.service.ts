...
export class CatzonaeconomicaService {
  ...
  public getCatalogo(): Observable<any> {
    return this.http.post(this.API_URL + '/catzonaeconomica/getCatalogo',
      {  }
      , httpOptions);
  }
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/catzonaeconomica/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack,actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/catzonaeconomica/setRecord',
      { dataPack,actionForm }
      , httpOptions);
  }
