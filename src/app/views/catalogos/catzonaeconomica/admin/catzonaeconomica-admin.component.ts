...
@Component({
  selector: 'app-catzonaeconomica-admin',
  templateUrl: './catzonaeconomica-admin.component.html',
  styleUrls: ['./catzonaeconomica-admin.component.css', '../../../_shared/shared.css']
})


export class CatzonaeconomicaAdminComponent implements OnInit {
  ...
  nombreModulo = 'Catzonaeconomica';

  headersAdmin: any;

  /* En el constructor creamos el objeto catzonaeconomicaService,
  ...
  constructor(
    private catzonaeconomicaService: CatzonaeconomicaService,private route: ActivatedRoute
  ) {
    ...
    this.headersAdmin = this.route.snapshot.data.userdata; // get data from resolver
      ...
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.catzonaeconomicaService.http
            .post<DataTablesResponse>(
              // this.API_URL + '/a6b_apis/read_records_dt.php',
              this.API_URL + '/catzonaeconomica/getAdmin',
  ...
  openModal(id: string, accion: string, idItem: string) {
    this.catzonaeconomicaService.open(id, accion, idItem);
  }

  closeModal(id: string) {
    this.catzonaeconomicaService.close(id);
  }
