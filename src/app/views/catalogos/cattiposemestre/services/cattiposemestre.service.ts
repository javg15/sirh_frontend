...
export class CattiposemestreService {
    ...
    return new Observable((o) => {
      setTimeout(() => {
        this.http.post<DataTablesResponse>(
          ...
          this.API_URL + '/cattiposemestre/getAdmin',
  ...
  public getCatalogoSegunSexo(id_sexo): Observable<any> {
    return this.http.post(this.API_URL + '/cattiposemestre/getCatalogoSegunSexo',
      { id_sexo }
      , httpOptions);
  }
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/cattiposemestre/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack, actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/cattiposemestre/setRecord',
      { dataPack, actionForm }
      , httpOptions);
  }
