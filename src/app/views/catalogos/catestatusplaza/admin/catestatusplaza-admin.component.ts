...
@Component({
  selector: 'app-catestatusplaza-admin',
  templateUrl: './catestatusplaza-admin.component.html',
  styleUrls: ['./catestatusplaza-admin.component.css', '../../../_shared/shared.css']
})


export class CatestatusplazaAdminComponent implements OnInit {
  ...
  nombreModulo = 'Catestatusplaza';

  headersAdmin: any;

  /* En el constructor creamos el objeto catestatusplazaService,
  ...
  constructor(
    private catestatusplazaService: CatestatusplazaService,private route: ActivatedRoute
  ) {
    ...
    this.headersAdmin = this.route.snapshot.data.userdata; // get data from resolver
      ...
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.catestatusplazaService.http
            .post<DataTablesResponse>(
              // this.API_URL + '/a6b_apis/read_records_dt.php',
              this.API_URL + '/catestatusplaza/getAdmin',
  ...
  closeModal(id: string) {
    this.catestatusplazaService.close(id);
  }
