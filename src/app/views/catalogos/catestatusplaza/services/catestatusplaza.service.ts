...
export class CatestatusplazaService {
  ...
  public getCatalogo(tipo:number=0): Observable<any> {
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/catestatusplaza/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack,actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/catestatusplaza/setRecord',
      { dataPack,actionForm }
      , httpOptions);
  }
