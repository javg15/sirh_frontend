...
export class CategoriastabularService {
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/categoriastabular/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack, actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/categoriastabular/setRecord',
      { dataPack, actionForm }
      , httpOptions);
  }
