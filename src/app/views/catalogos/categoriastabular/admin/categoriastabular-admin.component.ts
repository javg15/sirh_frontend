...
@Component({
  selector: 'app-categoriastabular-admin',
  templateUrl: './categoriastabular-admin.component.html',

})


export class CategoriastabularAdminComponent implements OnInit {
  ...
  nombreModulo = 'Categoriastabular';

  headersAdmin: any;

  /* En el constructor creamos el objeto categoriastabularService,
  ...
  constructor(
    private categoriastabularService: CategoriastabularService,private route: ActivatedRoute
  ) {
    ...
    this.headersAdmin = this.route.snapshot.data.userdata; // get data from resolver
      ...
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.categoriastabularService.http
            .post<DataTablesResponse>(
              // this.API_URL + '/a6b_apis/read_records_dt.php',
              this.API_URL + '/categoriastabular/getAdmin',
  ...
  openModal(id: string, accion: string, idItem: number) {
    this.categoriastabularService.open(id, accion, idItem);
  }

  closeModal(id: string) {
    this.categoriastabularService.close(id);
  }
