...
export class CatlocalidadesAdminComponent implements OnInit {
  ...
  nombreModulo = 'Catlocalidades';

  headersAdmin: any;

  /* En el constructor creamos el objeto catlocalidadesService,
  ...
  constructor(
    private catlocalidadesService: CatlocalidadesService,private route: ActivatedRoute
  ) {
    ...
    this.headersAdmin = this.route.snapshot.data.userdata; // get data from resolver
      ...
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.catlocalidadesService.http
            .post<DataTablesResponse>(
              // this.API_URL + '/a6b_apis/read_records_dt.php',
              this.API_URL + '/catlocalidades/getAdmin',
  ...
  closeModal(id: string) {
    this.catlocalidadesService.close(id);
  }
