...
export class CatnombramientosService {
    ...
    return new Observable((o) => {
      setTimeout(() => {
        this.http.post<DataTablesResponse>(
          ...
          this.API_URL + '/catnombramientos/getAdmin',
  ...
  public getCatalogo(): Observable<any> {
    return this.http.post(this.API_URL + '/catnombramientos/getCatalogo',
      {}
      , httpOptions);
  }
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/catnombramientos/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack, actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/catnombramientos/setRecord',
      { dataPack, actionForm }
      , httpOptions);
  }
