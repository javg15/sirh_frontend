...
export class HorasService {
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/horas/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack,actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/horas/setRecord',
      { dataPack,actionForm }
      , httpOptions);
  }
  ...
  public getCatalogo(): Observable<any> {
    return this.http.post(this.API_URL + '/horas/getCatalogo',
      {  }
      , httpOptions);
  }
