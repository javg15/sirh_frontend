...
export class PlantillasHistorialNominaComponent implements OnInit, OnDestroy {
  ...
  record_detalle: any = {
    "descempfuncion": "", "nombrect": "", "descplantelfisica": "", "descplantelplaza": "",
  ...
  ngOnInit(): void {
    ...
    //subtabla datatable
    this.headersAdmin = JSON.parse(this.route.snapshot.data.userdataHistorialNomina.cabeceras); // get data from resolver
