...
export class PlantillasdocsFamiliaresService {
    ...
    return new Observable((o)=>{
      setTimeout(()=>{
        this.http.post<DataTablesResponse>(
          ...
          this.API_URL + '/personalfamiliares/getAdmin',
  ...
  public getAdmin(dataTablesParameters): Observable<any> {
    return this.http.post(this.API_URL + '/personalfamiliares/getAdmin',
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/personalfamiliares/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack,actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/personalfamiliares/setRecord',
      { dataPack,actionForm }
      , httpOptions);
  }
